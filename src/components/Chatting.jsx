...
export default function Chatting({
  worker, message, messageChange, chatMessages, publishMessage,
}) {
  ...
  useEffect(() => {
    chatStore.setChats(chatMessages, worker.name);
    ...
    <Container>
      <Wrapper>
        ...
        <MenuWrapper>
          ...
          <button type="button" onClick={() => navigator(`/workers/${worker.id}/chats`)}>상담 목록</button>
        </MenuWrapper>
        <div>
          <ChattingBox>
            <ChattingList>
